...
#include "EnableInterrupt_util/ei_pindefs_speed.h"
#endif
...
#include "EnableInterrupt_util/ei_PinChange1284.h"
#elif defined ARDUINO_328
#include "EnableInterrupt_util/ei_PinChange328.h"
#elif defined ARDUINO_MEGA
#include "EnableInterrupt_util/ei_PinChange2560.h"
#elif defined ARDUINO_LEONARDO
#include "EnableInterrupt_util/ei_PinChangeLeonardo.h"
#elif defined EI_ATTINY24
#include "EnableInterrupt_util/ei_PinChangeTiny24.h"
#elif defined EI_ATTINY25
#include "EnableInterrupt_util/ei_PinChangeTiny25.h"
#endif
...
#undef EI_SECTION_FALLING
    ...
    // This is used in the EnableInterrupt_util/<#included files>, below.
...
#if defined MIGHTY1284
#include "EnableInterrupt_util/ei_External1284.h"
#elif defined ARDUINO_328
#include "EnableInterrupt_util/ei_External328.h"
#elif defined ARDUINO_MEGA
#include "EnableInterrupt_util/ei_External2560.h"
#elif defined ARDUINO_LEONARDO
#include "EnableInterrupt_util/ei_ExternalLeonardo.h"
#elif defined EI_ATTINY24
#include "EnableInterrupt_util/ei_ExternalTiny24.h"
#elif defined EI_ATTINY25
#include "EnableInterrupt_util/ei_ExternalTiny25.h"
#endif
...
#ifdef NEEDFORSPEED
#include "EnableInterrupt_util/ei_porta_speed.h"
#else
...
#ifdef NEEDFORSPEED
#include "EnableInterrupt_util/ei_portb_speed.h"
#else
...
#ifdef NEEDFORSPEED
#include "EnableInterrupt_util/ei_portc_speed.h"
#else
...
#ifdef NEEDFORSPEED
#include "EnableInterrupt_util/ei_portd_speed.h"
#else
...
#ifdef NEEDFORSPEED
#include "EnableInterrupt_util/ei_portj_speed.h"
#else
...
#ifdef NEEDFORSPEED
#include "EnableInterrupt_util/ei_portk_speed.h"
#else
