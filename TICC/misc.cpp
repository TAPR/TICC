...
// formatTimestampSplitTo removed - now using print_timestamp from timestamp_print.cpp
// formatSignedSplitTo removed - now using print_timestamp from timestamp_print.cpp

// formatTimeDifference removed - now using print_timestamp from timestamp_print.cpp
...
// normalizeSplit removed - now using Timestamp64 which handles normalization automatically

// diffSplit and absDeltaSplit removed - now using timestamp_difference from timestamp_print.cpp

// printTimestampSplit, printSignedSplit, and writeln64 removed - now using print_timestamp from timestamp_print.cpp
