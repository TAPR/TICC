...
# lines received per second.  Can handle TICC timestamp and binary
# formats (both old CRLF-separated and new fixed-frame formats).
...
def main():
    ...
    p.add_argument("--binary-mode", choices=["auto", "new", "old"], default="auto",
                   help="Binary format mode: 'auto' (detect), 'new' (12-byte fixed frames), "
                        "'old' (CRLF-separated). Default: auto")
    args = p.parse_args()
    ...
    binary_mode_detected = None  # None = not yet determined, "new", "old", or "text"
    ...
    try:
        while True:
            ...
            if args.binary_mode == "new" or (args.binary_mode == "auto" and binary_mode_detected == "new"):
            ...
            elif args.binary_mode == "old" or (args.binary_mode == "auto" and binary_mode_detected == "old"):
                # Old binary mode or text mode: CRLF-terminated
                ...
                if ch is None:
                    ...
                    if ch is not None and args.binary_mode == "auto" and binary_mode_detected is None:
                        binary_mode_detected = "old"
                        print("Auto-detected: old binary format (CRLF-separated)")
                elif args.binary_mode == "auto" and binary_mode_detected is None:
                ...
                if len(peek_data) >= 12 and peek_data[0] == 0x55 and peek_data[1] == 0xAA:
                    ...
                    # Not new binary, treat as CRLF-terminated
